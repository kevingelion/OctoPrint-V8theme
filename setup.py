...
plugin_identifier = "v8theme"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_v8theme"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-V8theme"
...
# module
plugin_description = """Voxel8's Theme for OctoPrint"""
...
plugin_url = "https://github.com/Voxel8/OctoPrint-V8theme"
